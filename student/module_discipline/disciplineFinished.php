		...
		<tr> 
			...
			?>
				...
				<form action="" method="post" autocomplete="off">
					หมายเลขคดี 
					<? $_resDis = mysql_query("select dis_id from student_disciplinestatus where student_id = '" . $_SESSION['username'] . "' and acadyear = '" . $acadyear . "' and acadsemester = '" . $acadsemester . "'"); ?>
