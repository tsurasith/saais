...
*/
if (typeof FusionCharts === "undefined") throw alert("FusionChartsExport: object::FusionCharts was not found. Verify script inclusions.", 10901271400), "FusionChartsExportComponentFatalError::10901271400";
var _FCEO = function () {
...
_FCEO.prototype.render = function (a) {
    a = _FCEO.L.get(a);
    if (!a || !_FCEO.L.isObj(a.innerHTML, "string")) return this.trace(_FCEO.R.errContainer, 10902091233), !1;
    this.update();
    try {
...
_FCEO.relayStream = function (a) {
    ...
    if (_FCEO.probeComponent(b)) return _FCEO.pushStream(b, [a]), !0;
...
_FCEO.probeCharts = function () {
    ...
    for (var e = 0; e < b.length; e++) a = b[e], _FCEO.probeChart(a) && d.push(a);
    b = _FCEO.L.tags("embed");
    for (e = 0; e < b.length; e++) a = b[e], a.parentNode != void 0 && a.parentNode.tagName == "object" || _FCEO.probeChart(a) && d.push(a);
    return d
};
...
_FCEO.initializeComponent = function (a, b) {
    (!b || !b.length || b.length < 1) && _FCEO.trace(_FCEO.R.errArgs, 10902061902);
    var d = !_FCEO.L.isString(b[0]) && b.length == 1;
    !d && b.length < 2 && _FCEO.trace(_FCEO.R.errArgs, 10902091732);
    var e = 0,
        f;
    for (f in _FCEO.defaultParameters) a[f] = (d ? b[0][f] : b[e++]) || _FCEO.defaultParameters[f];
    (!_FCEO.L.isString(a.id) || !_FCEO.L.isString(a.swfLocation)) && a.trace(_FCEO.R.errArgs, 10902091820);
    _FCEO.playerVersion.major < 10 && (_FCEO.checkFlashVersion && !a.debugMode && !_FCEO.debugMode && alert(_FCEO.R.msgNoPlayer),
...
_FCEO.updateComponent = function (a) {
    ...
    try {
        ...
        b = d("width");
        if (b != void 0) _FCEO.__global ? (a.srcObj.width = b.toString(), a.srcObj.flashVars.width =
            b.toString()) : (a.srcObj.setAttribute("width", b), a.srcObj.addVariable("width", b));
        b = d("height");
...
_FCEO.batchExport = function (a, b) {
    ...
    for (var f = parseInt(a.componentAttributes.strictTrigger || 0) == 0 ? function (a) {
            return a
        } : function (b) {
            b.handlerId = a.id;
            return b
        ...
        if (g == null) a.trace(_FCEO.R.errFusion, 10902092026);
            ...
            a.exportAttributes.exportParameters.triggerOrdinal =
                e++;
...
_FCEO.L = {
    ...
    getNew: function (a) {
        for (var b = document.createElement(a), d, e = 1; c < arguments.length; e++) d = arguments[e].split("="), b.setAttribute(d[0], d[1]);
        return b
    },
    sync: function (a, b) {
